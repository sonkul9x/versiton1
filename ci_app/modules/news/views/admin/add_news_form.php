...
$startups_checked = ($startups == 1) ? 'checked' : ''; 
...
<div class="page_header">
    ...
    <small class="fleft">"Nội dung bài viết"</small>
    <span class="fright"><a class="button close" href="<?php echo NEWS_ADMIN_BASE_URL; ?>/" title="Đóng"><em>&nbsp;</em>Đóng</a></span>
    <br class="clear"/>
</div>
    ...
    <div class="tab_container">
        <div id="tab1" class="tab_content">
            <table>
                ...
                <tr><td class="title">Tiêu đề bài viết: (<span>*</span>)</td></tr>
                <tr>
                    <td><?php echo form_input(array('name' => 'title', 'size' => '50', 'maxlength' => '256', 'style' => 'width:560px;', 'onkeyup'=>'convert_to_slug(this.value);', 'value' => $title)); ?></td>
                </tr>
                ...
                <?php } ?>
                <tr><td class="title">Phân loại bài viết: (<span>*</span>)</td></tr>
                <tr>
                ...
                <tr><td class="title" style="vertical-align: top">Nội dung bài viết: (<span>*</span>)</td></tr>
                <tr>
                    <td>
                        <?php echo form_textarea(array('id' => 'content', 'name' => 'content', 'value' => ($content != '') ? $content : set_value('content'), 'class' => 'wysiwyg elm1')); ?>
                    </td>
                </tr>
                <tr><td class="title">Ngày đăng bài viết: (<span>*</span>)</td></tr>
                <tr>
                    <td>
...
<!--                <tr><td class="title">Hiển thị trên trang chủ:</td></tr>
                <tr>
                    <td><?php // echo form_checkbox(array('name' => 'startups', 'value' => $startups , 'checked' => $startups_checked, 'onclick'=>'startups_check();')); ?></td>
                </tr>-->
