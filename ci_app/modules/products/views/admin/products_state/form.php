...
echo form_hidden('form', 'products_state');
?>

<div class="page_header">
    <h1 class="fleft"><?php if(isset($header)) echo $header;?></h1>
    <small class="fleft">"Thêm/sửa tình trạng"</small>
    <span class="fright"><a href="<?php echo PRODUCTS_STATE_ADMIN_BASE_URL; ?>" class="button close" style="padding:5px;" title="Đóng"><em></em><span>Đóng</span></a></span>
    <br class="clear"/>
</div>
...
<div class="tab_container">
    <div id="tab1" class="tab_content">
        <table>
            <tr><td class="title">Tình trạng: (<span>*</span>)</td></tr>
            <tr>
