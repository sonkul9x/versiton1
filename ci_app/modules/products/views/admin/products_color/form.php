...
<div class="page_header">
    ...
    <small class="fleft">"Thêm/sửa màu sắc"</small>
...
<div class="tab_container">
    <div id="tab1" class="tab_content">
        <table>
            <tr><td class="title">Tên màu: (<span>*</span>)</td></tr>
            <tr>
                <td><?php echo form_input(array('name' => 'name', 'size' => '50', 'maxlength' => '255', 'style' => 'width:560px;', 'value' => isset ($name) ? $name : set_value('name'))); ?></td>
            </tr>
            <tr><td class="title">Mã màu: (<span>*</span>)</td></tr>
            <tr>
                <td><?php echo form_input(array('name' => 'code', 'class' => 'color', 'size' => '50', 'maxlength' => '255', 'style' => 'width:100px;', 'value' => isset ($code) ? $code : set_value('code'))); ?></td>
            </tr>
        </table>
    </div>
