...

{
...

    {
        ...
        case 1  : $output = 'Thanh toán khi nhận hàng'; break;

        case 2 : $output = 'Thanh toán chuyển khoản ngân hàng'; break;

        case 3 : $output = 'Thanh toán tại cửa hàng'; break;
...

{
...

    {
        ...
        case ILLUSIVE_ORDER : $output = '<img src="/powercms/images/close.png" title="Đơn hàng bị hủy"/>'; break;

        case NEW_ORDER      : $output = '<img src="/powercms/images/warning.png" title="Đơn hàng chưa giao" />'; break;
