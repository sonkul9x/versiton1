...
<div class="page_header">
    ...
    <small class="fleft">"Thêm/sửa phân loại bộ sưu tập ảnh"</small>
    <span class="fright"><a href="<?php echo GALLERY_CAT_ADMIN_BASE_URL; ?>" class="button close" style="padding:5px;" title="Đóng"><em></em><span>Đóng</span></a></span>
    <br class="clear"/>
</div>
