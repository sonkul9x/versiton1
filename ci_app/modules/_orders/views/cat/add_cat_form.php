...
<div class="page_header">
    ...
    <small class="fleft">"Thêm/sửa phân loại hỏi đáp"</small>
    <span class="fright"><a href="<?php echo FAQ_CAT_ADMIN_BASE_URL; ?>" class="button close" style="padding:5px;" title="Đóng"><em></em><span>Đóng</span></a></span>
    <br class="clear"/>
</div>
...
<div class="tab_container">
    <div id="tab1" class="tab_content">
        <table>
            ...
            <tr>
                <td><?php echo form_input(array('name' => 'category', 'size' => '50', 'maxlength' => '255', 'style' => 'width:200px;', 'value' => isset ($category) ? $category : set_value('category'))); ?></td>
            </tr>

            <tr><td class="title">Thuộc phân loại:</td></tr>
            <tr>
                <?php echo form_hidden('is_add_edit_category', TRUE);?>
                <?php echo form_hidden('form', 'faq_cat');?>
