    ...
    <div class="tab_container">
        <div id="tab1" class="tab_content">
            <table>
                ...
                <tr>
                    <td><?php echo form_input(array('name' => 'tel', 'size' => '50', 'maxlength' => '255', 'style' => 'width:560px;', 'value' => $tel)); ?></td>
                </tr>
                ...
                <tr><td class="title">Ngày đặt hàng: (<span>*</span>)</td></tr>
                <tr>
                    <td>
                ...
                <tr><td class="title">Ngày giờ yêu cầu giao hàng: (<span>*</span>)</td></tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <?php echo form_textarea(array('id' => 'message', 'name' => 'content', 'value' => ($message != '') ? $message : set_value('message'), 'class' => 'wysiwyg')); ?>
                    </td>
                </tr>
            ...
            <table class="list" style="width: 100%; margin-bottom: 10px;">
                ...
                if (isset($order_detail)) {
                    ...
                    foreach ($order_detail as $index => $orders):
                        ...
                        $amount = $amount + $tong;
                        $uri = get_base_url() . url_title($orders->product_name, 'dash', TRUE) . '-ps' . $orders->product_id;
                        ?>
                        <tr class="<?php echo $style ?>">
                            <td><?php echo '#' . $orders->order_id; ?></td>
                            <td><?php echo '#' . $orders->product_id ?></td>
                            <td style="white-space:nowrap;"><a href="<?php echo $uri;?>" target="blank"><?php echo $orders->product_name; ?></a></td>
                            <td style="white-space:nowrap;"><?php echo $orders->quantity; ?></td>
                            <td  style="white-space:nowrap;color: red;"><?php echo $price; ?></td>
                            <td  style="white-space:nowrap;color: red;"><?php echo $total; ?></td>

                        </tr>
                    <?php endforeach; ?>
                        <tr class="odd">
                           <?php $amounts = $amount != 0 ? get_price_in_vnd($amount) . ' VND' : get_price_in_vnd($amount);?>
                            <td class="right" colspan="5" style="white-space:nowrap;"><b>Tổng giá trị đơn hàng</b></td>
                            <td  style="white-space:nowrap;color: red;"><?php echo $amounts; ?></td>

                        </tr>
                        <tr class="odd">
                                <td colspan="6" style="text-align: right; color: red;font-weight: bold" class="total_price"><?php echo DocTienBangChu($amount); ?> </td>
                        </tr>
                <?php } ?>
            </table>
        </div>
