...
//        }
    ...
    public function get_order_status_combo($options = array())

    {
...

        {
            ...
            $options['combo_name'] = 'order_status';
        ...
        $data_options['-1']  = 'Tất cả trạng thái đơn hàng';

        $data_options['0']   = 'Khách hàng oder';

        $data_options['1']   = 'Đơn hàng đã gửi đi';

        $data_options['2']   = 'Đơn hàng bị hủy';

        $data_options['3']   = 'Đơn hàng đã hoàn tất';
